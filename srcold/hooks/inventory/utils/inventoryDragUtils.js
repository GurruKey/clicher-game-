...
export const performBagEquipSwap = ({
  ...
  // IMPORTANT: If we are swapping a bag that was in a bag, 
  // we must use nextBag as potential place for the old bag too? 
  // No, the original logic placeBagInBaseSlots only works with baseSlots.
  // This is a limitation: unequipped bags ALWAYS go to base inventory.
